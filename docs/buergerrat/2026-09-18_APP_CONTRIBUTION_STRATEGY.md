...
| R5 | **Money only on the rails that exist.** Münzen rewards and tips, Gemeinschaftskasse honoraria. No forwarded donations, no cooperative shares, no ticket money held for third parties. | Donor-directed forwarding is Finanztransfergeschäft (ZAG); there is no e.V. or eG yet ([legal masterplan](../future-research/LEGAL_MASTERPLAN.md)). |
...
4. **Pop-up events** are events; ticketing beyond free RSVP is out (R5).
