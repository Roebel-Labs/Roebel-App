...
export function WorkInProgressNotice() {
  return (
    <div className="flex items-start gap-3 rounded-[10px] border border-[#00498B]/20 bg-[#00498B]/5 p-4 text-sm text-foreground">
      <Info className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#00498B]" />
      <p>
