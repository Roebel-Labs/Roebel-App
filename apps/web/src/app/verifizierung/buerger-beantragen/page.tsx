                  ...
                  <>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                      ...
                      <div className="bg-card p-6 rounded-lg flex justify-center mb-4">
                        <QRCodeSVG
                          value={`https://roebel.app/verifizierung/nachweis/${requestId}?contract=citizen`}
                          size={200}
                          level="H"
                        />
                      </div>
                      ...
                      <button
                        onClick={() => {
                          const link = `https://roebel.app/verifizierung/nachweis/${requestId}?contract=citizen`;
                      ...
                      <div className="text-center">
                        <Link
                          href={`/verifizierung/nachweis/${requestId}?contract=citizen`}
