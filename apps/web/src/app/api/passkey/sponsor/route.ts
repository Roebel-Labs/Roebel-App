 ...
 *
 * Only a genuine passkey Safe for the request's (x, y) acting for a citizen
 * identity is sponsored: its own `legacy` thirdweb account, the Safe itself
 * (after a v3 moveTo), or a citizen wallet it helps recover - see
