...
import { updateNewsArticle } from "@/app/actions/news"
...
export default function EditNewsPage() {
    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          author_email: data.author_email || "admin@roebel.de",
  ...
  const handleSubmit = async (e: React.FormEvent, status: "draft" | "published") => {
    ...
    const loadingToast = toast.loading(
      status === "published" ? "Artikel wird aktualisiert..." : "Entwurf wird gespeichert..."
    )

    const result = await updateNewsArticle(articleId, submitData)
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-medium text-foreground">Artikel bearbeiten</h1>
          <p className="text-muted-foreground mt-1">Bearbeiten Sie den Nachrichtenartikel</p>
        </div>
      </div>
