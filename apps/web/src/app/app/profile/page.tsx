  ...
  return (
    <>
      <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-card border border-border rounded-lg overflow-hidden mb-3 sm:mb-4">
            ...
            <div className="px-4 sm:px-6 pb-4 sm:pb-5">
              ...
              <div className="-mt-10 sm:-mt-12 mb-3">
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full border-4 border-card bg-muted overflow-hidden relative">
              ...
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="shrink-0 ml-3 px-3 py-1.5 text-xs font-medium bg-card border border-border hover:bg-accent text-foreground rounded-lg transition-colors"
                >
                  Bearbeiten
                </button>
              </div>
          ...
          {/* Interests & Vereine */}
          {((user.interests && user.interests.length > 0) || (user.vereine && user.vereine.length > 0)) && (
            ...
            {hasCitizen ? (
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-foreground hover:bg-foreground/90 text-white py-2 rounded-md text-sm font-medium transition-colors"
                >
          ...
          {account?.address && (
            <div className="mb-3 sm:mb-4">
              <BusinessProfileSection walletAddress={account.address} />
            </div>
          )}
            ...
            <div className="bg-card border border-border rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
              ...
              {(loadingAttester || loadingCitizen) ? (
                <div className="flex items-center justify-center py-6 sm:py-8">
                  <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-foreground"></div>
                </div>
              ) : (() => {
                ...
                if (totalMyRequests === 0) {
                  return (
                    <div className="text-center py-6">
                      ...
                      <Link
                        href="/verifizierung"
                        className="inline-block bg-foreground hover:bg-foreground/80 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors"
                      >
                        Jetzt beantragen
                      </Link>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {myAttesterRequests.map((request) => (
                      <Link
                        ...
                        className="block p-3 bg-muted hover:bg-accent border border-border hover:border-foreground rounded-lg transition-all"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
          ...
          {/* Privacy + Edit buttons */}
          <div className="flex gap-2 mb-3 sm:mb-4">
            <button
              onClick={() => setShowEditModal(true)}
              className="flex-1 bg-card border border-border hover:bg-accent text-foreground py-2 rounded-md text-xs sm:text-sm font-medium transition-colors active:scale-95"
            >
              Profil bearbeiten
            </button>
            <button
