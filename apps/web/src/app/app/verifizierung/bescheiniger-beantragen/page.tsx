                  ...
                  <>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                      ...
                      <div className="bg-card p-6 rounded-lg flex justify-center mb-4">
                        <QRCodeSVG
                          value={`https://roebel.app/app/verifizierung/nachweis/${requestId}?contract=attester`}
                          size={200}
                          level="H"
                        />
                      </div>
                      ...
                      <button
                        onClick={() => {
                          const link = `https://roebel.app/app/verifizierung/nachweis/${requestId}?contract=attester`;
                      ...
                      <div className="text-center">
                        <Link
                          href={`/app/verifizierung/nachweis/${requestId}?contract=attester`}
