  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-4 sm:mb-6">
        <Link href="/app/verifizierung" className="text-sm sm:text-base text-muted-foreground hover:text-foreground transition-colors inline-flex items-center gap-1">
