...
export default function BusinessAnalyticsSlugScreen() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const [analyticsData, dealsData] = await Promise.all([
        fetchDealAnalytics(biz.id),
        fetchDealsByBusiness(biz.id),
      ]);
                    ...
                    <View style={styles.listItemLeft}>
                      ...
                      <View style={styles.listItemInfo}>
                        ...
                        <Text style={[styles.listItemStatus, { color: colors.textTertiary }]}>
                          {deal.status === 'active' ? 'Aktiv' : deal.status === 'draft' ? 'Entwurf' : deal.status === 'paused' ? 'Pausiert' : deal.status}
                        </Text>
                      </View>
                    </View>
