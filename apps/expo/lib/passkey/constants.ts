...
export const PASSKEY_RP_ID = 'id.ortis.app';
export const PASSKEY_RP_NAME = 'Röbel';
export const PASSKEY_ORIGIN = 'https://id.ortis.app';

/** PRF salt = keccak256("id.ortis.app/passkey-prf/v1") (32 bytes). */
export const PASSKEY_PRF_SALT: Hex = keccak256(stringToHex('id.ortis.app/passkey-prf/v1'));
