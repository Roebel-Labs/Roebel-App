...
SELECT
  ...
  -- Posted as the 'Bürger für Röbel' organisation account (Max's decision, 2026-09-17,
  -- revised from Stadt Röbel); the wallet stays Max's so the owner-checked RPCs still work.
  '9373a71a-53a3-44b7-b2b0-ea128fb4c27c',
  r.category,
  r.title,
  r.body,
  'published',
