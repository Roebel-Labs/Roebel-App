      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputArea}>
          <View style={styles.mediaRow}>
            ...
            <TouchableOpacity
              onPress={() => setShowEmojiTray((p) => !p)}
              style={[
                styles.mediaChip,
                { backgroundColor: colors.primaryLight, borderColor: colors.primary },
              ]}
              accessibilityLabel="Emoji öffnen"
            >
          ...
          {showEmojiTray && (
            <View style={[styles.emojiTray, { borderColor: colors.border }]}>
              {QUICK_EMOJIS.map((e) => (
                <TouchableOpacity
                  key={e}
                  onPress={() => {
                  ...
                  style={styles.emojiTrayItem}
                >
                  <Text style={styles.emojiTrayText}>{e}</Text>
                </TouchableOpacity>
              ))}
            </View>
          )}
